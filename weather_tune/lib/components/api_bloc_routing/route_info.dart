...
class DetailsAPI extends StatefulWidget {
  const DetailsAPI({super.key});

  @override
  State<DetailsAPI> createState() => _DetailsAPIState();
}

class _DetailsAPIState extends State<DetailsAPI> {
  @override
